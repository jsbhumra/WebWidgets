...
export default function Login()
{
    ...
    <div className='body'>
        <div className="textdiv">
            ...
            <p className="ms-1"> <span className='question'>Become a member?</span> <a className='redirect' href="../signup">Register</a></p>
        </div>
        ...
        <div className="flex flex-col gap-4 mt-10 form">
            <div className="flex flex-wrap md:flex-nowrap mb-2 gap-4 inputlg">
                <Input classNames={{label: "after:content-[']"}} type="email" name="email" variant="bordered" color="default" label="Email " isRequired />
            </div>
            <Input
                label="Password"
                name="pass"
